"""
Django settings for lemme_39816 project.
...
WSGI_APPLICATION = 'lemme_39816.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lemme_39816 API",
    "DESCRIPTION": "API documentation for lemme_39816 App",
    "VERSION": "v1",
}
